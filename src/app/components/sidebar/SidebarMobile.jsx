...
const SidebarMobile = () => {
  ...
  return (
    <section className="h-screen bg-secondary rounded-tl-2xl rounded-bl-2xl overflow-y-auto">
      <div className="px-6 pt-4 flex justify-center items-center flex-row gap-4 h-20">
        ...
        {/* Search Bar */}
        <div className="h-10 w-full bg-lsecondary text-txt rounded-lg p-2 flex gap-2 text-md items-center">
