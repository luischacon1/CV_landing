const Pinned = () => {
  return (
    <section className="h-32 px-4">
      {/* Social Links - 1 row layout with 4 buttons */}
      <div className="flex justify-center items-center h-full">
        <div className="flex gap-4 justify-center">
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <h3 className="text-sm text-txt">GitHub</h3>
          </div>
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <h3 className="text-sm text-txt">LinkedIn</h3>
          </div>
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <h3 className="text-sm text-txt">YouTube</h3>
          </div>
          ...
          <div className="flex flex-col gap-1 items-center">
            ...
            <h3 className="text-sm text-txt">Resume</h3>
          </div>
        </div>
      </div>
    </section>
